...
from app.models.profile import PatientProfileCreate, PatientProfileUpdate, PatientProfileResponse
...
async def update_patient_profile(
    ...
    if existing_profile:
        ...
        profile_doc = {
            ...
            "start_weight_kg": profile_data.start_weight_kg,
...
async def create_progress_report(
    ...
    existing_report = await progress_collection.find_one({
        "patient_id": current_user["_id"],
        "week_start": progress_data.week_start
    })
    ...
    return {
        ...
        "week_start": progress_doc["week_start"],
